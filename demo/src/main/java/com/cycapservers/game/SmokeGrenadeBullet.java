...
public class SmokeGrenadeBullet extends Bullet {
	 ...
	 * @param max_height
	 */
	public SmokeGrenadeBullet(int sprIdx, double startX, double startY, double endX, double endY, 
			double w, double h, GameCharacter p, String entity_id, int fx, double max_height, int smoke_time, int intensity) {

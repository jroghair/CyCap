...
public class ArtilleryShell extends Bullet{
	 ...
	 * @param max_height
	 */
	public ArtilleryShell(int sprIdx, double startX, double startY, double endX, double endY, 
			double w, double h, int damage, GameCharacter p, String entity_id, int fx, double max_height) {

...
public abstract class GameCharacter extends Entity {
	...
	public GameCharacter(int id, int sprIdx, double x, double y, double w, double h, double r, double a,
			String entity_id, int team, String role) {
	...
	public void takeDamage(int amount, GameCharacter c) {
		...
		if (this.health <= 0) {
			...
			if (!c.entity_id.equals(this.entity_id)) {
				c.stats.addKill(); // adds a kill if you didn't kill yourself
									// lmao
			}
		}
	}

...
public class Lobby {
	 ...
	 * 
	 * @return A gameState Assosiated with the lobby.
	 */
	...
	/**
	 * Adds a player to the lobby. Also checks to see if the game is full and if
	 * so sends a message to start the game.
	 * 
	 * @param p
	...
	public boolean addPlayer(String p, WebSocketSession s) throws IOException {
		players.add(new IncomingPlayer(p, "recruit", s)); // TODO: this needs to
															// use the role that
															// was chosen on the
															// lobby page
		this.curSize++;

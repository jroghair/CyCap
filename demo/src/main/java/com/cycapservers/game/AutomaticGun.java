...
public class AutomaticGun extends Weapon {
	...
	public void fire(GameCharacter p, InputSnapshot s, GameState g) {
		...
		g.bullets.add(new Bullet(this.bullet_type, p.x, p.y, s.mapX, s.mapY, 
				Utils.GRID_LENGTH * 0.125, Utils.GRID_LENGTH * 0.125, 0, 1.0, 
				this.bullet_speed, this.damage, this.shot_variation, p, id));

...
/**
 * Account Controller class handles website navigation for registering an game
 * play, account, logging in to an existing account, player profiles and lobby
 * navigation
 * 
...
public class AccountController {
	 ...
	 * 
	 * @return String html page for a successful registration that takes you
	...
	/**
	 * Controller for handling login requests after a user enters their
	 * credentials and submits
	 * 
	 * @param model
	 *            model for account
	 * @param account
	 *            session attribute for user, set when a user logs in
	...
	/**
	 * Controller for handling "GET" mapping request for users friends based on
	 * account session gathered from login
	 * 
	 * @param model
	 *            model request for
	 * @param request
	 *            webpage server request
	 * @param account
	 *            session attribute for userid, set when user logs in
	 * @param friends
	 */
	@RequestMapping(value = "/accounts/friends", method = RequestMethod.GET)
	public String friends(Model model, HttpServletRequest request, @SessionAttribute("account") Account account,
			@ModelAttribute("friends") Friends friends) {
	 ...
	 *            logging in
	 * @param Friend
	 *            model attribute from Friends model already generated
	 * @return View returns a View containing a users Friends
	 */
	@RequestMapping(value = "/accounts/friendAdd", method = RequestMethod.POST)
	public View friendAdd(HttpServletRequest request, @SessionAttribute("account") Account account,

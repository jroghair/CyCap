...
public class Profiles {
	...
	/**
	 * Id is the primary key of the profiles table within the database. This
	...
	/**
	 * Role for a specific character class for a user. This field cannot be
	 * null.
	 */
	@NotNull
	...
	/**
	 * Total flag grabs for a user as a specific role. This field cannot be
	 * null.
	 */
	@NotNull
	...
	/**
	 * Total flag returns for a user as a specific role. This field cannot be
	 * null.
	 */
	@NotNull
	...
	/**
	 * Total flag captures for a user as a specific role. This field cannot be
	 * null.
	 */
	@NotNull
	...
	/**
	 * Total Experience gained for a user as a specific role. This field cannot
	 * be null.
	 */
	@NotNull
	 ...
	 * @param level
	 */
	public Profiles(String userID, String champion, int kills, int deaths, int gamewins, int gamelosses,
			int gamesplayed, int flaggrabs, int flagreturns, int flagcaptures, int experience, int level,
			int scoutunlocked, int artilleryunlocked, int infantryunlocked) {
		this.userID = userID;
	...
	public int getScoutunlocked() {
		return scoutunlocked;
	}

	public void setScoutunlocked(int scoutunlocked) {
		this.scoutunlocked = scoutunlocked;
	}
	...
	public int getInfantryunlocked() {
		return infantryunlocked;
	}

	public void setInfantryunlocked(int infantryunlocked) {
		this.infantryunlocked = infantryunlocked;
	}
